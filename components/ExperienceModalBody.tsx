...
const ExperienceModalBody : React.FC = () => (
  <div className="px-6 flex flex-col items-center justify-center">
    ...
    <button className="mt-4">
      ...
      <p className="text-sm font-semibold text-blue-100 leading-5">https://nearlabs.app/app/docu_s...</p>
    </button>
    <div className="flex mt-9">
      <Image src="/twitter.png" alt="" width="24" height="24" />
      <Image className="mr-6" src="/discord.png" alt="" width="24" height="24" />
      <Image className="mr-6" src="/telegram.png" alt="" width="24" height="24" />
    </div>
  </div>
)
